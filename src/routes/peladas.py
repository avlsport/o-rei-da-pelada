...
def criar_pelada():
    ...
    try:
        ...
        print(f"DEBUG: Dados recebidos: {data}")  # Debug
        
        if not data or not data.get("nome"):
            print("DEBUG: Nome da pelada não fornecido")  # Debug
            return jsonify({"error": "Nome da pelada é obrigatório"}), 400
        
        print(f"DEBUG: Criando pelada com nome: {data['nome']}")  # Debug
        ...
        print(f"DEBUG: Pelada criada com ID: {pelada.id}")  # Debug
        ...
        print(f"DEBUG: Membro admin criado para pelada {pelada.id}")  # Debug
